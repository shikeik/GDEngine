...
public class HealthBarDemoScreen extends ExampleGScreen {
	...
	private Stage stage;
	private SkewBar p1Bar; // P1: 左倾, 蓝, 左->右
	private SkewBar p2Bar; // P2: 右倾, 红, 右->左
